...
public interface EquipMapper extends BaseMapper<Equip> {
	...
	@Select({
		...
		" 		and nvl(a.\"sEquip_StoreLv2\", '@') = nvl(b.\"sUserStore_StoreLv2ID\", '@') ",
		" 		and nvl(a.\"sEquip_StoreLv3\", '@') = nvl(b.\"sUserStore_StoreLv3ID\", '@') ",
		" 		and nvl(a.\"sEquip_StoreLv4\", '@') = nvl(b.\"sUserStore_StoreLv4ID\", '@') ",
		" where ",
	...
	@Select({
		...
		" 		and nvl(a.\"sEquip_StoreLv2\", '@') = nvl(e.\"sUserStore_StoreLv2ID\", '@') ",
		" 		and nvl(a.\"sEquip_StoreLv3\", '@') = nvl(e.\"sUserStore_StoreLv3ID\", '@') ",
		" 		and nvl(a.\"sEquip_StoreLv4\", '@') = nvl(e.\"sUserStore_StoreLv4ID\", '@') ",
		" 	left join \"tBase_Aid\" e1 on a.\"sEquip_AidID\" = e1.\"sAid_ID\" ",
		" 	left join \"tBase_UserStation\" f1 on f1.\"sUserStation_Station\" = e1.\"sAid_Station\" ",
		" where ",
    	" 	<if test=\" map != null \"> ",
    	"		<foreach collection=\"map.keys\" item=\"item\"  index=\"i\" separator=\"and\">",
    	" 			a.\"${item}\" = #{map[${item}]}",	
	...
	@Select({
		...
		" 		and nvl(a.\"sEquip_StoreLv2\", '@') = nvl(e1.\"sUserStore_StoreLv2ID\", '@') ",
		" 		and nvl(a.\"sEquip_StoreLv3\", '@') = nvl(e1.\"sUserStore_StoreLv3ID\", '@') ",
		" 		and nvl(a.\"sEquip_StoreLv4\", '@') = nvl(e1.\"sUserStore_StoreLv4ID\", '@') ",
